function Q=controllo_interno_CLS(K,ddqmax, U)
   %% inizialization 
        n=7;
        ...
        comp=Vettore_coriolis_classical(dq,q)+Gravita_classical(q,9.81)+function_friction_CLS(dq)'; %compensazione degle effetti fisici
         Q=Funzione_inerzia_classical(q)*y+comp; %torque imposed on robot
end